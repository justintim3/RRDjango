...
urlpatterns = [
    ...
    path('csres/', views.search_Comic_by_Title, name = 'csres'),
    path('charcsres/', views.search_Comic_by_Character, name = 'charcsres'),
    path('creacsres/', views.search_Comic_by_Creator, name = 'creacsres'),
